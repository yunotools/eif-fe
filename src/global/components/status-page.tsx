...
export function StatusPage({
  ...
  return (
    <div className="mx-auto flex min-h-[68vh] max-w-2xl flex-col justify-center py-16">
      <div className="text-7xl font-black leading-none text-[var(--accent)]">{code}</div>
      ...
      <div className="mt-7 flex gap-3">
        <Link href="/" className="eif-button eif-button-primary">Trang chủ</Link>
        <Link href="/about/" className="eif-button eif-button-secondary">Giới thiệu</Link>
      </div>
    </div>
  );
}
